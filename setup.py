...
if sys.version_info < min_version:
    sys.exit(
        f"csxtools does not support Python {sys.version_info[0]}.{sys.version_info[1]}. "
        f"Python {min_version[0]}.{min_version[1]} and above is required."
    )
...
# ----------------------
# C extensions (full import paths)
# ----------------------
fastccd = Extension(
...
setuptools.setup(
    ...
    cmdclass={**versioneer.get_cmdclass(), "build_ext": CustomBuildExt},
