...
from .axis import correct_images
...
def get_axis_images(light_header, dark_header=None,
...
def get_axis_timestamps(header, tag='axis1_image'):
...
def get_axis_flatfield(light, dark, flat=None, limits=(0.6, 1.4), half_interval=False):
    ...
    """
    images = get_images_to_3D(get_axis_images(light, dark, flat))
